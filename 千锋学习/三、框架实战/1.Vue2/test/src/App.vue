<template>
  <div id="app">
    ...
    >
      ...
      <el-submenu index="2">
        <template slot="title">测试&练习</template>
    ...
    <component :is="activeIndex" style="padding: 10px"></component>
  </div>
</template>

<script>
import Comp1x1 from './案例/01-分页组件/Father.vue'

import Test from './测试&练习/test/index.vue'
